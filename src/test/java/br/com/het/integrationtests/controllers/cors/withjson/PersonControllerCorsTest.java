package br.com.het.integrationtests.controllers.cors.withjson;
...
class PersonControllerCorsTest extends AbstractIntegrationTest {
        ...
        void create() throws JsonProcessingException {
                ...
                assertEquals("New York City - New York - USA", createdPerson.getAdress());
        ...
        void createWithWrongOrigin() throws JsonProcessingException {
                ...
                specification = new RequestSpecBuilder()
                                .addHeader(TestConfigs.HEADER_PARAM_ORIGIN, TestConfigs.ORIGIN_TROLL)
                                .setBasePath("/api/person/v1")
                                .setPort(TestConfigs.SERVER_PORT)
                                .addFilter(new RequestLoggingFilter(LogDetail.ALL))
                                .addFilter(new ResponseLoggingFilter(LogDetail.ALL))
        ...
        private void mockPerson() {
                ...
                person.setAdress("New York City - New York - USA");
