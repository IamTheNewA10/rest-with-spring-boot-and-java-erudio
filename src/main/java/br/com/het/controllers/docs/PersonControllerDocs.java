...
public interface PersonControllerDocs {
        ...
        @Operation(summary = "Massive People Insertion", description = "Massive People Creation with Upload of XLSX or CSV", tags = {
                        "People" }, responses = {
                                        @ApiResponse(description = "Success", responseCode = "200", content = {
        ...
        @Operation(summary = "Export People", description = "Export a Page of People in CSV or XLSX Format", tags = {
                        "People" }, responses = {
                                        @ApiResponse(description = "Success", responseCode = "200", content = {
        ...
        @Operation(summary = "Find People By FirstName", description = "Finds People By Their First Name", tags = {
                        "People" }, responses = {
                                        @ApiResponse(description = "Success", responseCode = "200", content = {
                                                        @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, array = @ArraySchema(schema = @Schema(implementation = PersonDTO.class)))
                                        }),
        ...
        @Operation(summary = "Disable a Person", description = "Disable a specific person by his ID", tags = {
                        "People" }, responses = {
                                        @ApiResponse(description = "Success", responseCode = "200", content = @Content(schema = @Schema(implementation = PersonDTO.class))),
                                        @ApiResponse(description = "No Content", responseCode = "204", content = @Content),
                                        @ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
